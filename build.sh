export CLANG_PATH="/opt/homebrew/opt/llvm/bin/"
export CROSS_COMPILE="$HOME/src/proton-clang/bin/aarch64-linux-gnu-"
export python="python3"

lkmake V=1 ARCH=arm64 SUBARCH=arm64 LLVM=1 LLVM_IAS=1 O=out vendor/kona-perf_defconfig -j69
lkmake V=1 ARCH=arm64 SUBARCH=arm64 LLVM=1 LLVM_IAS=1 O=out -j69
